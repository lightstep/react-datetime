...
var DateTimePickerDays = onClickOutside( React.createClass({
	render: function() {
		...
		tableChildren = [
			DOM.thead({ key: 'th' }, [
				DOM.tr({ key: 'h' }, [
					DOM.th({ onClick: this.props.subtractTime( 1, 'months' ), key: 'p', className: 'rdtPrev' }, DOM.span({}, '‹' )),
					...
					DOM.th({ onClick: this.props.addTime( 1, 'months' ), key: 'n', className: 'rdtNext' }, DOM.span({}, '›' ))
				]),
